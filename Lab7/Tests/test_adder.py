...
class TestAdder(unittest.TestCase):
    ...
    def test_add_user(self):
        ...
        self.history_manager.log.assert_called_once_with("Додати користувача", "Додано користувача: Test User (test@example.com)")
    ...
    def test_add_post(self):
        ...
        # Перевіряємо, чи викликано метод для запису історії
        self.history_manager.log.assert_called_once_with("Додати пост", "Додано пост: Test Post")
