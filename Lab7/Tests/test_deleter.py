...
class TestDeleter(unittest.TestCase):
    ...
    def test_delete_user_found(self):
        ...
        self.history_manager.log.assert_called_once_with("Видалити користувача", "Видалено користувача з ID 1")
    ...
    def test_delete_post_found(self):
        ...
        # Перевіряємо, чи викликано метод для запису історії
        self.history_manager.log.assert_called_once_with("Видалити пост", "Видалено пост з ID 1")
